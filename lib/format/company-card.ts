...
/**
 * Полная карточка компании для внутренних каналов (Telegram-выдача партнёрам).
 * ВНИМАНИЕ: содержит название, ИНН и цену — в Avito такие данные отправлять
 * нельзя (INV-4), там используется lib/export/client-list.ts.
 */
